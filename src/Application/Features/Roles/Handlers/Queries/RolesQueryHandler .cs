...
namespace Application.Features.Roles.Handlers.Queries;
    ...
    IRequestHandler<GetAllClaimsQuery, BaseResponse<IEnumerable<string>>>
{
    ...
    public async Task<BaseResponse<IEnumerable<string>>> Handle(GetAllClaimsQuery request,
    ...
    public async Task<BaseResponse<IEnumerable<string>>> Handle(GetAllRolesQuery request,
        CancellationToken cancellationToken)
    {
    ...
    public async Task<BaseResponse<IEnumerable<string>>> Handle(GetRoleClaimsQuery request,
        CancellationToken cancellationToken)
    {
    ...
    public async Task<BaseResponse<IEnumerable<string>>> Handle(GetUserClaimsQuery request,
        CancellationToken cancellationToken)
    {
    ...
    public async Task<BaseResponse<IEnumerable<string>>> Handle(GetUserRolesQuery request,
        CancellationToken cancellationToken)
    {
